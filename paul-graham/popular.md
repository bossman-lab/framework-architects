...
[Source](http://www.paulgraham.com/popular.html)
...
the relative popularity of programming languages &mdash; legacy software
(Cobol) and hype (Ada, Java) also play a role &mdash; but I think it is
...
transitive verb &mdash; hackers are usually hacking something &mdash; and in
...
Given that you can supply the three things any language needs &mdash; a
free implementation, a book, and something to hack &mdash; how do you
...
of a struct &mdash; to comb out references to a deleted object, for example,
...
Classic macros are a real hacker's tool &mdash; simple, powerful, and
...
It might be a good idea to have an active profiler &mdash; to push
...
launched &mdash; programming languages especially. Nothing could be better,
...
are horizontal instead of vertical &mdash; so that modules are always
...
very best hackers &mdash; the ones who took 6.001 and understood it, for
example. And those are the users you need to win.

In "How to Become a Hacker," Eric Raymond describes Lisp as something
like Latin or Greek &mdash; a language you should learn as an intellectual
