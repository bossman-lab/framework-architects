...
asking how to make a startup succeed &mdash; if you avoid every cause of
failure, you succeed &mdash; and that's too big a question to answer on
the fly.
...
different than they originally intended &mdash; often so different that
...
sounds &mdash; almost impossibly hard in fact &mdash; because business guys
...
the new CEO wanted to switch to Windows &mdash; even after PayPal cofounder
...
you down&mdash;so money that's getting consumed faster has to last
...
time sink &mdash; more work, probably, than the startup itself.   And you
...
one that doesn't do much of anything &mdash; the one we never even hear
