...
They didn't know.  Whatever was going to happen&mdash;whatever Web 2.0
turned out to be.
...
percentile writing&mdash;95% of articles are improved by it, but 5% are
...
to be new&mdash;that it didn't predict anything.
...
[6]
  ...
  medium&mdash;which fails, and then the more appropriate models get
  figured out.
...
component, for example&mdash;that's not an innovation, in the sense of
...
there when it does.  That's the way to approach technology&mdash;and 
