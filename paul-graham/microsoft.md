...
[Source](http://www.paulgraham.com/microsoft.html)
...
indirectly&mdash;for example, in the spam I got from botnets.  And
...
Microsoft anymore.  They still make a lot of money&mdash;so does IBM,
...
live on the web&mdash;not just email, but everything, right up to
...
that it would be useful to a lot of other people too&mdash;in fact, to
...
The surprising fact is, brilliant hackers&mdash;dangerously brilliant
hackers&mdash;can be had very cheaply, by the standards of a
...
All you have to do is not work too hard at fixing bugs&mdash;which, if
