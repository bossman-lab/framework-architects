...
[Source](https://gwern.net/death-note-script)
...
anime, Haskell, R (language), Bayes, stylometry
...
(The exact PDF I used has the SHA-256 hash: `3d0d66be9587018082b41f8a676c90041fa2ee0455571551d266e4ef8613b08a`2.)
...
10−510⋅0.510−510⋅0.5+(1−0.5)=0.5⋅0.50.5⋅0.5+0.5=0.250.25+0.5=0.250.75=13=0.33


In this example, 33% seems like a reasonable answer (and interestingly, it’s not simply 50%⋅510=25%).
...
P(a) = probability of being real = 0.899
- 

P(¬a) = probability of being not real = 1 - 0.899 = 0.101
- 

P(b|a) = probability a real script will have no ownership claim = 99% (shit happens9) = 0.99
- 

P(b|¬a) = probability a fake script will have no ownership claim = probability someone will claim it is the hope function with n = 20, i = 3, L0 = 50% = 20−320⋅0.520−320⋅0.5+(1−0.5)=0.45945, so the probability someone will not is 1−0.45945=0.54055


Then Bayes:


P(a|b)=P(b|a)⋅P(a)(P(b|a)⋅P(a))+(P(b|¬a)⋅P(¬a))=0.99⋅0.899(0.99⋅0.899)+(0.54055⋅0.101)=0.942
...
P(a) = probability of being real = 0.942
- 

P(¬a) = probability of being not real = 1 - 0.942 = 0.05149
- 

P(b|a) = probability a real script will have copies taken down = 50% = 0.50
- 

P(b|¬a) = probability a fake script will have copies taken down = 5%+5% = 0.10


Then Bayes:


P(a|b)=P(b|a)⋅P(a)(P(b|a)⋅P(a))+(P(b|¬a)⋅P(¬a))=0.5⋅0.942(0.5⋅0.942)+(0.1⋅0.058)=0.9878
...
To update using a likelihood ratio (some more reading material: “Simplifying Likelihood Ratios”), we express our P(a) as instead P(a)1−P(a), multiply by the likelihood ratio, and convert back! So for our table: we start with 0.51−0.5=1, multiply by 1.8, 0.538, 1…5:


0.51−0.5⋅1.8⋅0.538⋅1⋅2⋅1.033⋅1.5⋅2.999⋅1.831⋅5=82.3


And we convert back as 82.31+82.3=0.98 - like magic, our final posterior reappears. Knowing the product of our likelihood ratios is the factor to multiply by, we can easily run other examples. What of the person starting with a 10% prior? Well:


0.101−0.10⋅82.3=9.1$and$9.11+9.1=0.90


And a 1% person is 0.011−0.01⋅82.3=0.83 and 0.831+0.83=0.45 Ooh, almost to 50%, so we know anyone with a prior of 2% who accepts the analysis may be moved all the way to thinking the script more likely to be true than not (specifically, 0.62).
...
0.51−0.5⋅2.74=3.087; 2.741+2.74=0.73
...
Redo the calculations, but instead of being restricted to point estimates, work on intervals: give what you feel are the endpoints of 95% credence intervals for P(b|a) & P(b|¬a) and run Bayes on the endpoints to get worst-case and best-case posteriors, to feed into the next argument evaluation
- 
...
0.51−0.5⋅82.3⋅0.25=20.5 and then we have a new posterior: 20.51+20.5=0.95
...
So: I believe the script is real, if not exactly what the Parlapanides brothers wrote.
 ...
 @Cparlapanides Finished analysis of leaked 2009 script: Gwern.net/Death-Note-script Dying to know: was I right? Was it really you & your brother's?
...
> (page should work on desktop) Weird! Shane Black said Ryuk gone https://www.animenewsnetwork.com/news/2011-10-31/director/warner-death-note-is-still-in-the-works Maybe edited script? What about "Luke Murray" etc.?
>
>
> Oh yeah, since you can't open the page - the whole script is at <>
>
...
I abbreviate p(b|is real)p(b|is not real) as $LR(b)4, and p(b|is real&c)p(b|is not real&c) as LR(b|c).
...
SHA-512: `954082c8cde2ccee1383196fe7c420bd444b5b9e5d676b01b3eb9676fa40427983fb27`​`ad8458a784ea765d66be93567bac97aa173ab561cd7231d8c017a4fa70`↩︎
- 

The raw metadata can be extracted using `pdftk` like thus: `pdftk 2009-parlapanides-deathnotemovie.pdf dump_data`:
...
The fake Batman script is pretty weird; it starts off interesting and has many good parts, but then flounders in opaqueness and concludes even more weirdly with far too much material in it for a single film to plausibly include. If it were supposed to be by anyone but Christopher Nolan, you’d comment “this can’t be real - the plot is too flabby and confusing, and the dialogue veers into non sequiturs and half-baked philosophy” (which of course it is). But one expects that of Nolan, almost, and for the filmed movie to be better than the script, so paradoxically, the worsening quality may have lent it some credibility.↩︎
- 
...
The earliest Tweet I can find using SnapBird (a defunct Twitter archive service) tying him to LA is 2011-06-10 (other searches like “moving”, “move”, “relocating”, “California”, “CA”, “New Jersey”, “NJ” etc. do not turn up anything useful). This is probably because his tweets do not go further back than April 201115ya, where there is mention of some sort of hacking of his account. The next step is a Google search for `Charley Parlapanides ("New Jersey" OR "Los Angeles" OR California)` with a date range of 6/1/2009-6/9/201115ya (to pick up any locations given from when they started on the script to just before that 2011-06-10 tweet). Results were equivocal: a 2011-02-12 blog comment about “this town” might indicate residence in LA/Hollywood; a 2010-12-19 mention of walking into a director’s production office of sets & costumes might indicate residence as well. Beyond that, I can’t find anything.↩︎
- 

Quick, of the anime aired 20 years ago in 1992, how many are active franchises? Of the 48 on the first page, maybe 3 or 4 seem active.↩︎
- 
...
Sir Thomas Browne, Hydriotaphia, Urn Burial (chapter 5):
